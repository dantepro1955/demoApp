...
public final class btr {
    /* renamed from: a */
    public static Map<String, String> m10949a(Locale locale) {
        ...
        btr.m10950a(hashMap, locale.getLanguage());
        String valueOf = String.valueOf(locale.getLanguage());
        String valueOf2 = String.valueOf(locale.getCountry());
        btr.m10950a(hashMap, new StringBuilder((String.valueOf(valueOf).length() + 1) + String.valueOf(valueOf2).length()).append(valueOf).append("_").append(valueOf2).toString());
        return hashMap;
    }

    /* renamed from: a */
    private static void m10950a(Map<String, String> map, String str) {
        if ("af".equals(str)) {
        ...
        } else if (AnalyticsSQLiteHelper.EVENT_LIST_AM.equals(str)) {
        ...
        } else if (AnalyticsEvent.TYPE_END_SESSION.equals(str)) {
