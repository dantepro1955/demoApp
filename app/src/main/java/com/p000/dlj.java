...
public class dlj implements Interpolator {
    ...
    public float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f21995b.length - 1)) * f), f21995b.length - 2);
        float f2 = (f - (((float) min) * f21996c)) / f21996c;
        return ((f21995b[min + 1] - f21995b[min]) * f2) + f21995b[min];
    }
}
