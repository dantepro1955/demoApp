...
public interface bsy extends IInterface {
    ...
    /* renamed from: bsy$a */
    public static abstract class C1451a extends Binder implements bsy {

        /* renamed from: bsy$a$a */
        static class C1450a implements bsy {
            /* renamed from: a */
            private IBinder f7575a;

            C1450a(IBinder iBinder) {
                this.f7575a = iBinder;
            }

            /* renamed from: a */
            public final void mo1436a(String str, IBinder iBinder) throws RemoteException {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    mo1436a(parcel.readString(), parcel.readStrongBinder());
    ...
    /* renamed from: a */
    void mo1436a(String str, IBinder iBinder) throws RemoteException;
}
