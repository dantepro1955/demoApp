...
public interface aua extends IInterface {
    ...
    /* renamed from: aua$a */
    public static abstract class C0825a extends Binder implements aua {

        /* renamed from: aua$a$a */
        static class C0824a implements aua {
            /* renamed from: a */
            private IBinder f4592a;
            ...
            public boolean getBooleanFlagValue(String str, boolean z, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4592a.transact(2, obtain, obtain2, 0);
            ...
            public int getIntFlagValue(String str, int i, int i2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.f4592a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public long getLongFlagValue(String str, long j, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeLong(j);
                    obtain.writeInt(i);
                    this.f4592a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String getStringFlagValue(String str, String str2, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f4592a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void init(aqq aqq) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.flags.IFlagProvider");
                    obtain.writeStrongBinder(aqq != null ? aqq.asBinder() : null);
                    this.f4592a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static aua asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof aua)) ? new C0824a(iBinder) : (aua) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    init(C0701a.m4966a(parcel.readStrongBinder()));
    ...
    void init(aqq aqq) throws RemoteException;
}
