...
class aqn {
    ...
    /* renamed from: aqn$a */
    static abstract class C0694a extends C0683a {
        /* renamed from: a */
        private int f3951a;

        protected C0694a(byte[] bArr) {
            boolean z = false;
            if (bArr.length != 25) {
                int length = bArr.length;
                String valueOf = String.valueOf(apz.m4898a(bArr, 0, bArr.length, false));
                ...
                aoi.m4689b(z, "cert hash data has incorrect length. length=" + bArr.length);
            }
            this.f3951a = Arrays.hashCode(bArr);
        }

        /* renamed from: a */
        protected static byte[] m4951a(String str) {
            try {
        ...
        public boolean equals(Object obj) {
            ...
            try {
                ...
                return Arrays.equals(mo612c(), (byte[]) aqr.m4968a(a));
            } catch (Throwable e) {
    ...
    /* renamed from: aqn$b */
    static class C0695b extends C0694a {
        /* renamed from: a */
        private final byte[] f3952a;
    ...
    /* renamed from: aqn$c */
    static abstract class C0696c extends C0694a {
        /* renamed from: b */
        private static final WeakReference<byte[]> f3953b = new WeakReference(null);
        /* renamed from: a */
        private WeakReference<byte[]> f3954a = f3953b;
        ...
        byte[] mo612c() {
            byte[] bArr;
            synchronized (this) {
                bArr = (byte[]) this.f3954a.get();
                if (bArr == null) {
                    bArr = mo613d();
                    this.f3954a = new WeakReference(bArr);
                }
            }
            return bArr;
        }
