...
public interface azt extends IInterface {
    ...
    /* renamed from: azt$a */
    public static abstract class C0930a extends Binder implements azt {

        /* renamed from: azt$a$a */
        static class C0942a implements azt {
            /* renamed from: a */
            ...
            public void mo860a(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    obtain.writeInt(i);
                    this.f5191a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo861b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f5191a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo862c() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f5191a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo863d() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f5191a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: a */
        public static azt m6706a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof azt)) ? new C0942a(iBinder) : (azt) queryLocalInterface;
        }
    ...
    /* renamed from: a */
    void mo859a() throws RemoteException;

    /* renamed from: a */
    void mo860a(int i) throws RemoteException;

    /* renamed from: b */
    void mo861b() throws RemoteException;

    /* renamed from: c */
    void mo862c() throws RemoteException;

    /* renamed from: d */
    void mo863d() throws RemoteException;
}
