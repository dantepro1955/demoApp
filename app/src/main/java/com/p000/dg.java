...
/* renamed from: dg */
public abstract class dg extends SupportActivity {
    protected boolean mStartedIntentSenderFromFragment;

    protected abstract View dispatchFragmentsOnCreateView(View view, String str, Context context, AttributeSet attributeSet);
    ...
    protected static void checkForValidRequestCode(int i) {
        if ((-65536 & i) != 0) {
