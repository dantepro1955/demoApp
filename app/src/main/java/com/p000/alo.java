...
/* renamed from: alo */
public abstract class alo<T extends alo> {
    /* renamed from: a */
    public static String m2502a(Object obj) {
        return alo.m2503a(obj, 0);
    }

    /* renamed from: a */
    private static String m2503a(Object obj, int i) {
        if (i > 10) {
                        ...
                        if (obj instanceof Boolean) {
                            ...
                            if (obj instanceof List) {
                                ...
                                for (Object next : list) {
                                    ...
                                    stringBuffer.append(alo.m2503a(next, i + 1));
                                }
                                if (i > 0) {
                                    stringBuffer.append("]");
                                }
                                ...
                                for (Entry entry : new TreeMap((Map) obj).entrySet()) {
                                    Object a = alo.m2503a(entry.getValue(), i + 1);
    ...
    /* renamed from: a */
    public static String m2504a(Map map) {
        return alo.m2503a(map, 1);
    }

    /* renamed from: a */
    public abstract void mo1348a(T t);
}
